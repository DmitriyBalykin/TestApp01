...
function _normalizeArguments(effect, options, speed, callback) {
	...
	speed = $.fx.off ? 0 : typeof speed == 'number'
		? speed : speed in $.fx.speeds ? $.fx.speeds[speed] : $.fx.speeds.Default;
...
$.effects.fold = function(o) {
	...
	return this.queue(function() {
		...
		var duration = o.duration ? o.duration / 2 : $.fx.speeds.Default / 2;
...
function Datepicker() {
	...
	this.Defaults = { // Global defaults for all the date picker instances
...
$.extend(Datepicker.prototype, {
	...
	_attachDatepicker: function(target, settings) {
		...
		for (var attrName in this.Defaults) {
	...
	_optionDatepicker: function(target, name, value) {
		...
		if (arguments.length == 2 && typeof name == 'string') {
			return (name == 'defaults' ? $.extend({}, $.datepicker.Defaults) :
	...
	parseDate: function (format, value, settings) {
		...
		if (value == '')
			return null;
		var shortYearCutoff = (settings ? settings.shortYearCutoff : null) || this.Defaults.shortYearCutoff;
	...
	_get: function(inst, name) {
		return inst.settings[name] !== undefined ?
			inst.settings[name] : this.Defaults[name];
	},
